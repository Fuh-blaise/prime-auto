...
<body>
    ...
    <div class="banner " style="width:100%; height:500px;">
        <img src="img/dp3.jpg" alt="Snow" class="banner-img">
        ...
        <!-- header / form area ends here -->
            ...
            <h1 class="text-center">Don't have a Reg No?<a href="contact-us.php" class="btn">Talk to us</a></h1><>
            <h1 class="text-center">INDEPENDENT <span class="span"> VERIFIED </span> REVIEWS</h1><>
            <div class="display1">
        ...
        <!-- top selling brands -->
        <h1 class="text-center">TOP SELLING <span class="span">REPLACEMENT </span>ENGINES</h1><>
        <div class="display">
        ...
        <h1 class="text-center">OUR WORKING <span class="span">PROGRESS </span></h1>
        <div>
        ...
        <h1 class="text-center">OUR <span class="span">WORKSHOP </span>GALERRY</h1><><>
        ...
        <div class="display-gallery">
            ...
            <div class="img">
            <a href="img/img-11.jpg"> <img src="img/img-11.jpg" alt="renault 2"width="300" height="300"></a><>
        ...
        <center> <a href="gallery.html"class="btn">View Our Gallery &#8594</a></center>
