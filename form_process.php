...
if (empty($_POST["phone"])) {
  ...
  $phone_error = "input your number in international format e.g +27xxxxxx";
      }
  }
...
$subject = "New Message from Prime Auto Spares";
if (mail($to, $subject, $message_body)) {
$success = "Message Sent,Thank you for contacting us";
$success1 = "Message Sent,Thank you for your review";
