...
<body>
    ...
    <!-- form area  -->
    <div class="banner">
        <img src="img/dp1.jpg" alt="Snow" style="width:100%; height:500px;">
            ...
            <div class="row">
                ...
                <h1 class="text-center">Reconditioned Engines</h1>
                    <p2 class="p-text">
                        ...
                        Increase the life span of your luxury vehicle by fixing these <a href="reconditionedEngines.php">recon engines</a> at competitive rates that are easy to afford.
    ...
    <!-- view gallery -->
    <a href="gallery.html"class="btn">View Our Gallery &#8594</a>
